...
v3.1 corrects the central posture.
...
learn the native language generated by Collatz itself

The terminal question is deferred.
...
v3.4 maps the sentence forms generated by the current native extraction layer.
...
It asks:
    ...
    What sentence forms does Collatz produce?
...
The atlas classifies:
    ...
    dangerous sentences
    rare profiles
    dominant grammar profiles
    missing sentence forms
